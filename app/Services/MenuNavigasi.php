...
class MenuNavigasi
{
    ...
    private static function admin(): array
    {
        return [
            ...
            ['label' => 'Waktu Presensi', 'route' => 'admin.pengaturan.waktu-absen.index', 'icon' => 'jam', 'aktif' => ['admin.pengaturan.waktu-absen.*'], 'grup' => 'Konfigurasi'],
            ['label' => 'Lokasi Presensi', 'route' => 'admin.pengaturan.lokasi-absen.index', 'icon' => 'lokasi', 'aktif' => ['admin.pengaturan.lokasi-absen.*'], 'grup' => 'Konfigurasi'],
    ...
    private static function siswa(): array
    {
        return [
            ...
            ['label' => 'Presensi', 'route' => 'siswa.absensi', 'icon' => 'absensi', 'aktif' => ['siswa.absensi', 'siswa.absensi.*'], 'grup' => 'Akademik'],
    ...
    private static function guru(Pengguna $pengguna): array
    {
        ...
        if ($pengguna->isBk()) {
            $menu = array_merge($menu, [
                ...
                ['label' => 'Rekap Presensi', 'route' => 'bk.laporan.index', 'icon' => 'grafik', 'aktif' => ['bk.laporan.*'], 'grup' => 'BK'],
            ]);
        }
        ...
        if ($pengguna->isWaliKelas()) {
            $menu = array_merge($menu, [
                ...
                ['label' => 'Rekap Presensi', 'route' => 'wali-kelas.absensi.index', 'icon' => 'absensi', 'aktif' => ['wali-kelas.absensi.*'], 'grup' => 'Wali Kelas'],

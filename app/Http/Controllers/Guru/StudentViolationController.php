...
class StudentViolationController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('guru.pelanggaran-siswa.index', compact('studentViolations', 'classes', 'violationTypes', 'categoryLabels', 'sort', 'direction', 'search', 'filterClass', 'filterCategory', 'filterViolationType', 'filterDate'));
    }
    ...
    public function store(StoreStudentViolationRequest $request): RedirectResponse
    {
        ...
        StudentViolation::create($this->violationData($data, $violationType, includeRecorder: true));
    ...
    {
        $studentViolation->load(['studentProfile.user', 'studentProfile.class', 'violationType', 'recordedBy']);
        $categoryLabels = ViolationType::categoryLabels();

        return view('guru.pelanggaran-siswa.show', compact('studentViolation', 'categoryLabels'));
    }
     ...
     */
    private function violationData(array $data, ViolationType $violationType, bool $includeRecorder = false): array
    {
        $violationData = [

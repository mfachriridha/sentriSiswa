    ...
    <div class="w-full max-w-md mx-auto">
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8 sm:p-10 transition-all duration-300">
            <div class="mb-8 text-center">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-green-500/10 shadow-md border border-green-500/20">
            ...
            <form method="POST" action="{{ route('google.whatsapp.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-[10px] text-slate-400 font-medium">Contoh: 8123456789</p>
                </div>

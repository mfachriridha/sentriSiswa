    ...
    <div class="w-full max-w-md mx-auto">
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8 sm:p-10 transition-all duration-300">
            ...
            <form method="POST" action="{{ route('register.store') }}" class="space-y-5">
                ...
                {{--
                    Tombol ini mengirim formulir yang sama, hanya alamat tujuannya diganti.
                    Dengan begitu nomor HP guru ikut terkirim dan bisa diperiksa lebih dulu,
                    persis seperti pendaftaran biasa. Kolom email dan kata sandi sengaja
                    dilewati pemeriksaan peramban, karena dua kolom itu memang tidak
                    dipakai saat mendaftar lewat Google.
                --}}
                <button type="submit"
                        formaction="{{ route('google.daftar') }}"
                        formmethod="POST"
                        formnovalidate
                ...
                <p class="text-center text-[10px] font-medium text-slate-400">
                    Daftar lewat Google berarti akun Anda belum punya kata sandi. Nanti bisa dibuat lewat Lupa Kata Sandi atau Ganti Kata Sandi.
                </p>
            </form>

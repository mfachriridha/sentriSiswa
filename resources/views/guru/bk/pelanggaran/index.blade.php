...
<div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <a href="{{ route('guru.bk.pelanggaran.create') }}" class="rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary-dark">Buat Pengajuan</a>
</div>

<x-alert type="success" :message="session('success')" />

<form method="GET" action="{{ route('guru.bk.pelanggaran.index') }}" class="mb-4 flex flex-wrap gap-2 rounded-xl border border-gray-200 bg-white p-4">

...
<div class="rounded-xl border border-gray-200 bg-white p-4 lg:p-6">
    <form method="POST" action="{{ route('guru.bk.pelanggaran.store') }}" class="space-y-5">
        @csrf
        <div>
        ...
        <div class="flex justify-end gap-2">
            <a href="{{ route('guru.bk.pelanggaran.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700">Batal</a>

...
@php
    ...
    $biodataRows = [
        ...
        ['Tanggal Lahir', $biodata?->date_of_birth?->format('d/m/Y')],
        ...
        ['Tanggal Masuk', $biodata?->admission_date?->format('d/m/Y')],
                ...
                <table class="w-full text-left text-sm text-gray-600">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($student->studentViolations as $violation)
                            <tr>
                                <td class="whitespace-nowrap px-4 py-3">{{ $violation->violation_date->translatedFormat('d M Y') }}</td>
                                <td class="px-4 py-3">
                ...
                <table class="w-full text-left text-sm text-gray-600">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($student->attendances as $attendance)
                            ...
                            <tr>
                                <td class="whitespace-nowrap px-4 py-3">{{ $attendance->date->translatedFormat('d M Y') }}</td>
                                <td class="px-4 py-3">

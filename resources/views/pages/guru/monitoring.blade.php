<x-layouts::app.sidebar :title="__('Monitoring Siswa')">
    <div class="p-6">
        <flux:heading size="xl" class="mb-2">{{ __('Monitoring Siswa') }}</flux:heading>
        <flux:subheading class="mb-6">{{ __('Pantau pelanggaran dan poin siswa') }}</flux:subheading>
        <div class="p-8 text-center text-brand-500 border-2 border-dashed border-brand-300 rounded-xl bg-brand-50/50">
            <flux:icon.eye class="size-8 mx-auto mb-3 text-brand-400" />

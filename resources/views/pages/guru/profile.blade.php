<x-layouts::app.sidebar :title="__('Profile Guru')">
    <div class="p-6">
        <flux:heading size="xl" class="mb-2">{{ __('Profile Guru') }}</flux:heading>
        <flux:subheading class="mb-6">{{ __('Kelola informasi pribadi Anda') }}</flux:subheading>

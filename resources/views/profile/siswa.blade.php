...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="card text-center anim-up">
        <div class="relative inline-block mb-4">
            ...
            <button onclick="alert('UI Only: Upload foto!')" class="absolute bottom-1 right-1/2 translate-x-8 w-9 h-9 bg-emerald-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-emerald-700 transition">

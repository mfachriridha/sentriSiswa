...
<div class="mb-4 rounded-xl border border-gray-200 bg-white p-4">
    ...
    <div class="mt-3 flex flex-wrap gap-2">
        ...
        <a href="{{ route($routeName.'.cetak', request()->query()) }}" target="_blank" rel="noopener" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Cetak / Simpan PDF</a>
    </div>
</div>

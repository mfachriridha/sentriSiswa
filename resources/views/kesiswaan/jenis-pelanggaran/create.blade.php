...
<div class="rounded-xl border border-gray-200 bg-white p-6">
    <h1 class="mb-6 text-2xl font-bold text-gray-900">Tambah Jenis Pelanggaran</h1>
    ...
    <form method="POST" action="{{ route('kesiswaan.jenis-pelanggaran.store') }}" class="space-y-6"

    ...
    <form class="space-y-5" method="POST" action="{{ $isEdit ? route('admin.siswa.update', $s) : route('admin.siswa.store') }}">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div><label class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5 block">Kelas</label><input type="text" name="class_name" class="input-field" value="{{ $s?->schoolClass?->name ?? '' }}"></div>

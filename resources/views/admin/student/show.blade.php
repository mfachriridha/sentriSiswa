    ...
    @if ($biodata)
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                ...
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->place_of_birth ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Tanggal Lahir</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->date_of_birth?->format('d/m/Y') ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Jenis Kelamin</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->gender === 'L' ? 'Laki-laki' : ($biodata->gender === 'P' ? 'Perempuan' : '-') }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Agama</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->religion ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Status dalam Keluarga</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->family_status ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Anak Ke</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->child_number ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Sekolah Asal</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->school_of_origin ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Tanggal Diterima</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->admission_date?->format('d/m/Y') ?? '-' }}</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                ...
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->father_name ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Pekerjaan Ayah</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->father_occupation ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Nama Ibu</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->mother_name ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Pekerjaan Ibu</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->mother_occupation ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Alamat Orang Tua</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->parent_address ?? '-' }}</p>
            </div>

            <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                <p class="text-sm font-medium text-gray-500">Telepon Orang Tua</p>
                <p class="mt-1.5 text-base text-gray-900">{{ $biodata->parent_phone ?? '-' }}</p>
            </div>
        </div>
        ...
        @if ($biodata->guardian_name || $biodata->guardian_phone)
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                    ...
                    <p class="mt-1.5 text-base text-gray-900">{{ $biodata->guardian_name ?? '-' }}</p>
                </div>

                <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                    <p class="text-sm font-medium text-gray-500">Pekerjaan Wali</p>
                    <p class="mt-1.5 text-base text-gray-900">{{ $biodata->guardian_occupation ?? '-' }}</p>
                </div>

                <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                    <p class="text-sm font-medium text-gray-500">Alamat Wali</p>
                    <p class="mt-1.5 text-base text-gray-900">{{ $biodata->guardian_address ?? '-' }}</p>
                </div>

                <div class="rounded-lg border border-gray-100 bg-gray-50 p-5">
                    <p class="text-sm font-medium text-gray-500">Telepon Wali</p>
                    <p class="mt-1.5 text-base text-gray-900">{{ $biodata->guardian_phone ?? '-' }}</p>
                </div>
            </div>
        @endif
    @else

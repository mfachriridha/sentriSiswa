...
<div class="rounded-xl border border-gray-200 bg-white p-6">
    <div class="mb-6 text-center">
        ...
        <p class="mt-2 text-sm text-gray-500">Unggah file Excel berisi data siswa</p>
    </div>

    <div class="mb-6 flex items-center justify-center">
        <a href="{{ route('admin.siswa.impor.template') }}"
    ...
    <form method="POST" action="{{ route('admin.siswa.impor.unggah') }}" enctype="multipart/form-data" class="space-y-6"

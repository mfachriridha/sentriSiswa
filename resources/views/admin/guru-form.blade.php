...
<div class="card anim-up">
    ...
    <form class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                <label class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5 block">Mata Pelajaran <span class="text-blue-500 font-normal normal-case">(pilih &ge; 1)</span></label>

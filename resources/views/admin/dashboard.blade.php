...
<div class="card anim-up mb-6" style="animation-delay:.1s">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        <div class="flex gap-1 p-1 bg-[#edeeef] rounded-lg">
            <button onclick="switchData('kehadiran')" id="data-kehadiran" class="px-3 py-1.5 text-xs font-bold rounded-md bg-white shadow-sm text-[#001e40] transition">Kehadiran</button>
            <button onclick="switchData('guru')" id="data-guru" class="px-3 py-1.5 text-xs font-bold rounded-md text-muted hover:text-[#191c1d] transition">Guru</button>
            <button onclick="switchData('siswa')" id="data-siswa" class="px-3 py-1.5 text-xs font-bold rounded-md text-muted hover:text-[#191c1d] transition">Siswa</button>
            <button onclick="switchData('kelas')" id="data-kelas" class="px-3 py-1.5 text-xs font-bold rounded-md text-muted hover:text-[#191c1d] transition">Kelas</button>
        </div>
        <div class="flex gap-1 p-1 bg-[#edeeef] rounded-lg">
    ...
    <div id="data-guru-view" class="hidden h-52 flex items-center justify-center px-4">
        <div class="w-full max-w-md space-y-3">
            <div><div class="flex justify-between text-xs mb-1"><span>Matematika</span><span class="font-bold">12 guru</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-blue-500 h-3 rounded-full" style="width:40%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>Fisika</span><span class="font-bold">6 guru</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-cyan-500 h-3 rounded-full" style="width:20%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>Biologi</span><span class="font-bold">5 guru</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-emerald-500 h-3 rounded-full" style="width:17%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>BK</span><span class="font-bold">3 guru</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-purple-500 h-3 rounded-full" style="width:10%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>Lainnya</span><span class="font-bold">16 guru</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-slate-400 h-3 rounded-full" style="width:13%"></div></div></div>
        </div>
    </div>
    ...
    <div id="data-siswa-view" class="hidden h-52 flex items-center justify-center px-4">
        <div class="w-full max-w-md space-y-3">
            <div><div class="flex justify-between text-xs mb-1"><span>Kelas X</span><span class="font-bold">140 siswa</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-blue-500 h-3 rounded-full" style="width:39%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>Kelas XI</span><span class="font-bold">130 siswa</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-emerald-500 h-3 rounded-full" style="width:36%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>Kelas XII</span><span class="font-bold">90 siswa</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-amber-500 h-3 rounded-full" style="width:25%"></div></div></div>
        </div>
    </div>
    ...
    <div id="data-kelas-view" class="hidden h-52 flex items-center justify-center px-4">
        <div class="w-full max-w-md space-y-3">
            <div><div class="flex justify-between text-xs mb-1"><span>IPA</span><span class="font-bold">6 kelas</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-blue-500 h-3 rounded-full" style="width:50%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>IPS</span><span class="font-bold">4 kelas</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-emerald-500 h-3 rounded-full" style="width:33%"></div></div></div>
            <div><div class="flex justify-between text-xs mb-1"><span>Bahasa</span><span class="font-bold">2 kelas</span></div><div class="w-full bg-[#edeeef] rounded-full h-3"><div class="bg-amber-500 h-3 rounded-full" style="width:17%"></div></div></div>
        </div>
    </div>
</div>

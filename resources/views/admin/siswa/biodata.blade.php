...
<div class="rounded-xl border border-gray-200 bg-white p-6">
    <div class="mb-6 flex items-center gap-5">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Biodata {{ $siswa->nama }}</h1>
    ...
    <div class="mb-6">
        ...
        <div class="flex items-start gap-6"
             x-data="{ photoUrl: '{{ $siswa->profilSiswa?->foto ? asset('storage/'.$siswa->profilSiswa->foto) : '' }}', uploading: false, uploadError: '' }">
            ...
            <div class="flex flex-col gap-2">
                ...
                <template x-if="photoUrl">
                    <button type="button"
                            ...
                            @click="fetch('{{ route('admin.siswa.foto.hapus', $siswa) }}', {method: 'DELETE', headers: {'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').content, 'Accept': 'application/json'}}).then(() => { photoUrl = ''; })">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <form method="POST" action="{{ route('admin.siswa.biodata.update', $siswa) }}" class="space-y-8"
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input id="place_of_birth" type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $siswa->profilSiswa?->biodata?->tempat_lahir) }}"
                ...
                <div>
                    ...
                    <input id="date_of_birth" type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $siswa->profilSiswa?->biodata?->tanggal_lahir?->format('Y-m-d')) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                ...
                <div>
                    ...
                    <div class="flex items-center gap-6 mt-1">
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin', $siswa->profilSiswa?->biodata?->jenis_kelamin) === 'L' ? 'checked' : '' }}
                                   class="h-4 w-4 text-primary border-gray-300 focus:ring-primary">
                            <span class="text-sm text-gray-700">Laki-laki</span>
                        </label>
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin', $siswa->profilSiswa?->biodata?->jenis_kelamin) === 'P' ? 'checked' : '' }}
                                   class="h-4 w-4 text-primary border-gray-300 focus:ring-primary">
                ...
                <div>
                    ...
                    <input id="religion" type="text" name="agama" value="{{ old('agama', $siswa->profilSiswa?->biodata?->agama) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('agama')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <select id="family_status" name="status_keluarga"
                        ...
                        <option value="Kandung" {{ old('status_keluarga', $siswa->profilSiswa?->biodata?->status_keluarga) === 'Kandung' ? 'selected' : '' }}>Kandung</option>
                        <option value="Angkat" {{ old('status_keluarga', $siswa->profilSiswa?->biodata?->status_keluarga) === 'Angkat' ? 'selected' : '' }}>Angkat</option>
                        <option value="Tiri" {{ old('status_keluarga', $siswa->profilSiswa?->biodata?->status_keluarga) === 'Tiri' ? 'selected' : '' }}>Tiri</option>
                    </select>
                ...
                <div>
                    ...
                    <input id="child_number" type="number" name="anak_ke" min="1" value="{{ old('anak_ke', $siswa->profilSiswa?->biodata?->anak_ke) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('anak_ke')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input id="school_of_origin" type="text" name="asal_sekolah" value="{{ old('asal_sekolah', $siswa->profilSiswa?->biodata?->asal_sekolah) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('asal_sekolah')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input id="admission_date" type="date" name="tanggal_masuk" value="{{ old('tanggal_masuk', $siswa->profilSiswa?->biodata?->tanggal_masuk?->format('Y-m-d')) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('tanggal_masuk')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input id="father_name" type="text" name="nama_ayah" value="{{ old('nama_ayah', $siswa->profilSiswa?->biodata?->nama_ayah) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('nama_ayah')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input id="father_occupation" type="text" name="pekerjaan_ayah" value="{{ old('pekerjaan_ayah', $siswa->profilSiswa?->biodata?->pekerjaan_ayah) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                ...
                <div>
                    ...
                    <input id="mother_name" type="text" name="nama_ibu" value="{{ old('nama_ibu', $siswa->profilSiswa?->biodata?->nama_ibu) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('nama_ibu')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input id="mother_occupation" type="text" name="pekerjaan_ibu" value="{{ old('pekerjaan_ibu', $siswa->profilSiswa?->biodata?->pekerjaan_ibu) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('pekerjaan_ibu')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="parent_address" name="alamat_ortu" rows="2"
                              class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                     placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">{{ old('alamat_ortu', $siswa->profilSiswa?->biodata?->alamat_ortu) }}</textarea>
                    @error('alamat_ortu')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="parent_phone" type="text" name="telepon_ortu" value="{{ old('telepon_ortu', $siswa->profilSiswa?->biodata?->telepon_ortu) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('telepon_ortu')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input id="guardian_name" type="text" name="nama_wali" value="{{ old('nama_wali', $siswa->profilSiswa?->biodata?->nama_wali) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('nama_wali')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input id="guardian_occupation" type="text" name="pekerjaan_wali" value="{{ old('pekerjaan_wali', $siswa->profilSiswa?->biodata?->pekerjaan_wali) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="guardian_address" name="alamat_wali" rows="2"
                              class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                     placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">{{ old('alamat_wali', $siswa->profilSiswa?->biodata?->alamat_wali) }}</textarea>
                    @error('alamat_wali')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="guardian_phone" type="text" name="telepon_wali" value="{{ old('telepon_wali', $siswa->profilSiswa?->biodata?->telepon_wali) }}"
                           class="mt-1.5 block w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 shadow-sm
                                  placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors">
                    @error('telepon_wali')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>

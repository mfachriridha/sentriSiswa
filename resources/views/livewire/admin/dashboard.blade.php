<div class="p-6">
    <div class="mb-6">
        ...
        <flux:subheading class="text-zinc-700 text-base">{{ __('Ringkasan data absensi dan pelanggaran') }}</flux:subheading>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div class="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <flux:badge color="neutral" >{{ __('Total') }}</flux:badge>
            </div>
            <flux:heading size="xl" class="text-zinc-900 text-3xl">{{ $totalSiswa }}</flux:heading>
            <flux:text class="text-zinc-700 text-base mt-2">{{ __('Total siswa terdaftar') }}</flux:text>
        </div>
        ...
        <div class="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
            ...
            <flux:text class="text-zinc-700 text-base mt-2">{{ __('Siswa hadir hari ini') }}</flux:text>
        </div>
        ...
        <div class="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
            ...
            <flux:text class="text-zinc-700 text-base mt-2">{{ __('Tanpa keterangan') }}</flux:text>
        </div>
        ...
        <div class="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
            ...
            <flux:text class="text-zinc-700 text-base mt-2">{{ __('Pengajuan menunggu review') }}</flux:text>
        </div>
    </div>
</div>
